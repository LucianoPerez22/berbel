...
class __TwigTemplate_682cf16abc199030e8e907e9ae1f0b411bbd42147ebb225bb4994d52c278378f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 3
        $context["titlePage"] = $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("page.propiedades.title.edit");
        // line 4
        $context["menu"] = "areas";
        // line 5
        $context["pathCancel"] = $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("propiedad_list", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["entity"]) || array_key_exists("entity", $context) ? $context["entity"] : (function () { throw new RuntimeError('Variable "entity" does not exist.', 5, $this->source); })()), "area", [], "any", false, false, false, 5), "id", [], "any", false, false, false, 5)]);
        // line 1
        $this->parent = $this->loadTemplate("global/layout_form.html.twig", "propiedad/edit.html.twig", 1);
...
{% set titlePage = 'page.propiedades.title.edit' | trans %}
{% set menu = 'areas' %}
{% set pathCancel = path('propiedad_list', {'id' : entity.area.id}) %}
...
{% endblock %}", "propiedad/edit.html.twig", "/Users/lucianoperez/Documents/Zennovia/berbel/web/templates/propiedad/edit.html.twig");
    }
}
