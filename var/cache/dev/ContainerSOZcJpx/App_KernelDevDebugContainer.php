...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\AreaController' => 'getAreaControllerService',
            'App\\Controller\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\EmpleadoController' => 'getEmpleadoControllerService',
            'App\\Controller\\GroupController' => 'getGroupControllerService',
            'App\\Controller\\PropiedadController' => 'getPropiedadControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\UserController' => 'getUserControllerService',
            'App\\Zennovia\\Common\\BaseController' => 'getBaseControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/MacroAutoloadTwigExtension.php';
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\MacroAutoloadTwigExtension());
        ...
        $instance->addGlobal('base_path', $this->getEnv('BASE_PATH'));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('J2mIkDCkbU', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1oZxVeISWM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fxOCJFpUJ6', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AreasRepository' => ['privates', 'App\\Repository\\AreasRepository', 'getAreasRepositoryService', true],
            'App\\Repository\\EmpleadosRepository' => ['privates', 'App\\Repository\\EmpleadosRepository', 'getEmpleadosRepositoryService', true],
            'App\\Repository\\PropiedadesRepository' => ['privates', 'App\\Repository\\PropiedadesRepository', 'getPropiedadesRepositoryService', true],
        ], [
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('security.switch_user', [0 => function () {
            return ($this->privates['App\\Service\\SwitchUserSubscriber'] ?? $this->load('getSwitchUserSubscriberService'));
        }, 1 => 'checkSwitchAuthorization'], 0);
    ...
    /**
     * Gets the private '.service_locator.D1RJQph' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_D1RJQphService()
    {
        return $this->privates['.service_locator.D1RJQph'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZADC5GsmDW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eFU0CCEzUn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('coYeLKpAAF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1C+OwMOwsG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7w+8XXQR4w', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xy2nG4qEI+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.D1RJQph'] ?? $this->get_ServiceLocator_D1RJQphService()), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.secured_area' => ($this->privates['.security.request_matcher.HS_okLf'] ?? ($this->privates['.security.request_matcher.HS_okLf'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/*')));
        }, 2));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\Constraints\\ValidateDependentFieldsValidator' => ['privates', 'App\\Validator\\Constraints\\ValidateDependentFieldsValidator', 'getValidateDependentFieldsValidatorService', true],
            ...
            'app_validate_dependent_fields' => ['privates', 'App\\Validator\\Constraints\\ValidateDependentFieldsValidator', 'getValidateDependentFieldsValidatorService', true],
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'twig.form.resources' => [
                ...
                1 => 'form/form_theme.html.twig',
                2 => 'form/custom_types.html.twig',
            ],
