...
$catalogue = new MessageCatalogue('en', array (
  ...
  array (
    ...
    'custom.validator.empty_value' => 'This value should not be blank.',
    'custom.validator.start_date_ets' => 'This date must be less than ETS',
    'custom.validator.start_date_ats' => 'This date must be less than ATS',
    'custom.validator.exchange_rate_currencies_equal' => 'Exchange rate currencies can not be equals',
    'custom.passowrd.provide_current_password' => 'You must provide actual password',
    'custom.passowrd.provide_new_password' => 'You must provide a new password',
  ),
  'security' => 
  array (
  ...
  'email' => 
  array (
    'registration.message.subject' => 'Registration for Zennovia Skeleton',
    'registration.message.welcome' => 'Welcome to',
    'registration.message.explanation' => 'If you are receiving this mail it is because Zennovia Skeleton has registered this mail to <strong> create a user for you on the system. </strong>',
    'registration.message.next_step' => 'Select the following link and follow the corresponding steps to end the user registration process',
    'registration.message.greeting' => 'Yours faithfully',
    'registration.message.email_empty' => 'User does not have an email configured',
    'registration.message.send_error' => 'There was an error trying to send the email',
    'recover_password.message.subject' => 'Recover password from Zennovia Skeleton',
    'recover_password.message.title' => 'Request for password recovery',
    'recover_password.message.explanation' => 'We have received a password change request for the Zennovia Skeleton system user',
    'recover_password.message.next_step' => 'Select the following link and follow the corresponding steps to end the password reset process',
    'recover_password.message.greeting' => 'Yours faithfully',
    'recover_password.message.user_not_found' => 'We do not have this registered user with the email entered.',
    'recover_password.message.send_error' => 'The email with the code for the recovery of the password could not be sent. Please try again',
  ),
  'flashes' => 
  array (
    'flash.labels.error' => 'Error',
    'flash.labels.success' => 'Success',
    'flash.labels.warning' => 'Warning',
    'flash.labels.info' => 'Information',
    'flash.common.error_save' => 'There was an error trying to save the data',
    'flash.common.error_permission_create' => 'You cannot create this entity',
    'flash.common.error_permission_edit' => 'You cannot edit this entity',
    'flash.user.common.not_found' => 'The link provided is invalid',
    'flash.user.change_password.success' => 'Password was successfully changed',
    'flash.user.change_password.error' => 'There was an error trying to change the password',
    'flash.user.enable_disable.not_disabled' => 'This account can not be disabled',
    'flash.user.enable_disable.enabled' => 'The user was successfully enabled',
    'flash.user.enable_disable.disabled' => 'The user was successfully disabled',
    'flash.user.new.success' => 'User saved successfully',
    'flash.user.new.error' => 'An error occurred while trying to save the user',
    'flash.user.edit.success' => 'User edited successfully. %linkEntity%',
    'flash.user.edit.error' => 'An error occurred while trying to edit the user',
    'flash.user.registration.success' => 'You registered successfully. Enter your new password to access the system',
    'flash.user.registration.error' => 'There was an error with the registration, please try again later',
    'flash.user.recover_password.success' => 'Email was successfully sent for password recovery',
    'flash.user.recover_password.error' => 'There was an error with the recover password, please try again later',
    'flash.user.reset_password.success' => 'Password was changed successfully',
    'flash.group.new.success' => 'Permission group saved successfully',
    'flash.group.new.error' => 'An error occurred while trying to save the permission group',
    'flash.group.edit.success' => 'Permission group edited successfully. %linkEntity%',
    'flash.group.edit.error' => 'An error occurred while trying to edit the permission group',
    'flash.group.delete.success' => 'Permission group deleted successfully',
    'flash.group.delete.error' => 'This group is related to another entity. It can\'t be removed',
  ),
  'messages' => 
  array (
    'form.buttons.cancel' => 'Cancel',
    'form.buttons.save' => 'Save',
    'form.buttons.save_continue' => 'Save and Continue',
    'form.buttons.apply' => 'Apply',
    'form.buttons.clean' => 'Clean',
    'form.buttons.filter' => 'Filter',
    'form.buttons.enabled' => 'Enabled',
    'form.buttons.disabled' => 'Disabled',
    'form.buttons.accept_modal' => 'Yes, I want to continue',
    'form.buttons.pdf' => 'PDF',
    'form.buttons.return' => 'Return',
    'form.buttons.access' => 'Access',
    'form.buttons.send' => 'Send',
    'form.buttons.save_add_user' => 'Save & Add User',
    'form.buttons.save_add_contact' => 'Save & Add Contact',
    'form.info.field_required' => 'All fields with * are required',
    'form.labels.password' => 'Password',
    'form.labels.current_password' => 'Password',
    'form.labels.new_password' => 'New Password',
    'form.labels.repeat_password' => 'Repeat Password',
    'form.labels.user' => 'User',
    'form.labels.reciever' => 'To',
    'form.labels.send' => 'SEND',
    'form.labels.re' => 'Re',
    'form.labels.subject' => 'Subject',
    'form.labels.body' => 'Body',
    'form.labels.name' => 'Name',
    'form.labels.surname' => 'Surname',
    'form.labels.email' => 'Email',
    'form.labels.status' => 'Status',
    'form.labels.lastName' => 'Last Name',
    'form.labels.username' => 'Username',
    'form.labels.username_email' => 'Username or Email',
    'form.labels.admin' => 'Administrator',
    'form.labels.description' => 'Description',
    'form.labels.role' => 'Role',
    'form.labels.groups' => 'Groups',
    'form.labels.name_last_name' => 'Name and Surname',
    'form.labels.phone' => 'Phone',
    'form.labels.fax' => 'Fax',
    'form.labels.from' => 'From',
    'form.labels.to' => 'To',
    'form.labels.short_name' => 'Short Name',
    'form.labels.datetime' => 'Date & Time',
    'form.choices.select' => '--- SELECT ---',
    'form.choices.all' => 'All',
    'form.choices.enabled' => 'Enabled',
    'form.choices.disabled' => 'Disabled',
    'form.choices.true' => 'Yes',
    'form.choices.false' => 'No',
    'form.choices.load' => 'Load',
    'form.choices.unload' => 'Unload',
    ...
    'page.common.confirm.delete_record' => 'Delete record',
    'page.common.confirm.ask_continue' => 'Comfirm to remove this record?',
    'page.common.confirm.label' => 'Label',
    'page.common.confirm.delete_text' => 'Delete text',
    'page.list.buttons.view' => 'View',
    'page.list.buttons.edit' => 'Edit',
    'page.list.buttons.enable' => 'Enable',
    'page.list.buttons.disable' => 'Disable',
    'page.list.buttons.switch' => 'Switch',
    'page.list.buttons.delete' => 'Delete',
    'page.list.pagination.show' => 'Show',
    'page.list.pagination.records' => 'records',
    'page.list.pagination.firstPage' => 'First',
    'page.list.pagination.lastPage' => 'Last',
    'page.login.title' => 'Access to users',
    'page.login.recover_password' => 'Did you forget your password?',
    'page.login.remember' => 'Remember',
    'page.recover_password.title' => 'Did you forget your password?',
    'page.recover_password.description' => 'Enter your email and then we will send you an email with instructions on how to generate a new password.',
    'page.recover_password.return_to' => 'Return to',
    'page.registration.have_account' => 'Do you have an account?',
    'page.registration.enter' => 'Enter',
    'page.dashboard.title' => 'Dashboard',
    'page.menu.menu' => 'Menu',
    'page.menu.change_password' => 'Change Password',
    'page.menu.sign_out' => 'Sign Out',
    'page.menu.user' => 'User',
    'page.menu.group' => 'Group',
    'page.user.title.change_password' => 'Change Password',
    'page.user.title.reset_password' => 'Reset Password',
    'page.user.title.list' => 'User List',
    'page.user.title.view' => 'User View',
    'page.user.title.edit' => 'User Edit',
    'page.user.title.new' => 'New User',
    'page.user.labels.name' => 'Name',
    'page.user.labels.username' => 'Username',
    'page.user.labels.email' => 'Email',
    'page.user.labels.groups' => 'Groups',
    'page.user.labels.status' => 'Status',
    'page.user.buttons.add' => 'Add User',
    'page.user.confirm.label_enable' => 'Enable user',
    'page.user.confirm.label_disable' => 'Disable user',
    'page.user.confirm.body_enable' => 'You have selected the user to be enabled',
    'page.user.confirm.body_disable' => 'You have selected the user to be disabled',
    'page.group.title.list' => 'Group List',
    'page.group.title.view' => 'Group View',
    'page.group.title.edit' => 'Group Edit',
    'page.group.title.new' => 'Group New',
    'page.group.labels.name' => 'Name',
    'page.group.labels.description' => 'Description',
    'page.group.buttons.add' => 'Add Group',
  ),
));
