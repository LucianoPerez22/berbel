...
class getSecurity_Authentication_ManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.authentication.provider.dao.secured_area'] ?? $container->load('getSecurity_Authentication_Provider_Dao_SecuredAreaService'));
            yield 1 => ($container->privates['security.authentication.provider.rememberme.secured_area'] ?? $container->load('getSecurity_Authentication_Provider_Rememberme_SecuredAreaService'));
            yield 2 => ($container->privates['security.authentication.provider.anonymous.secured_area'] ?? $container->load('getSecurity_Authentication_Provider_Anonymous_SecuredAreaService'));
        }, 3), true);
